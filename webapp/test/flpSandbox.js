					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "재무제표 항목과 Non-SAP G/L 계정 매핑",
									"targetURL": "#pgdc0010-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"pgdc0010-display": {
								...
								"action": "display",
								"description": "Non-SAP 연결 단위 별로 GL 계정코드와 재무제표항목의 맵핑을 관리합니다.",
								"title": "재무제표 항목과 Non-SAP G/L 계정 매핑",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pgdc0010",
									"url": sap.ui.require.toUrl("pgdc0010")
								}
							}
						}
					}
